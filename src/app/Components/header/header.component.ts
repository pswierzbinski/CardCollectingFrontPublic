...
import { TuiAppearance, TuiButton, TuiDataList, TuiDropdown, TuiDropdownService, TuiIcon, } from '@taiga-ui/core';
...
export class HeaderComponent extends TuiPortals {
  ...
  constructor(public _accountService: AccountServiceService, private _router: Router) {
    super();
  }
  ngOnInit() {
    this.accountService.initUser();
    this.theme.color = '#062424';
  }
  logOut() {
