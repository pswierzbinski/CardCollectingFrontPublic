...
export class CreateCardRequest {
    ...
    constructor(name: string, series: string, type: string, faction: string, subtype: string, cost: number, loyalty: number, attack: number, defense: number, ruleText: string, description: string, artist: string, source: string, licence: string) {
        this._name = name;
        this._series = series;
        this._type = type;
